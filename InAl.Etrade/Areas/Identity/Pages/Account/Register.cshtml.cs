...
namespace InAl.Etrade.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            {
                RoleList=_roleManager.Roles.Where(x=>x.Name!=Other.Role_User).Select(y=>y.Name).Select(u=>new SelectListItem { 
                Text=u,
                Value=u
                })
            };
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (!await _roleManager.RoleExistsAsync(Other.Role_Member))
                    {
                        await _roleManager.CreateAsync(new IdentityRole(Other.Role_Member));
                    }
                    if (user.Role==null)
                    {
